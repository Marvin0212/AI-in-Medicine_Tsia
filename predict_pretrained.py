# -*- coding: utf-8 -*-
"""predict_pretrained.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1D-lp7E7lCe-n5PjMz6DfpAGlNTxLRsd7

# Import Librarys und Zugriff auf Daten
...
Schneller Zugriff auf Daten zu unterschiedlichen Zeitpunkten im Traingsvorgang
"""
...
Preprocessing um die Daten auf die gewünschte Länge zu bringen
"""
...
"""Daten aus dem ZIP File werden mit ihrem Label in ein Numpy Array übertragen"""
...
-Aufteilung Trainings und Validierungsdaten

-Daten Augmentation durch in die länge ziehen der Daten zwischen 10% und 30%

-Datenset Balancieren, sodass Trainingsdaten 50% Normal- und 50% Afib- Daten beinhaltet
"""
...
"""# Fast Fourier Transformation der Daten

hier wird noch die Frequenzgrenze berechnet für welche Frequenz 99% der Informationen im Spektrum erreicht sind. kann zur Beseitigung von Rauschen benutzt werden
"""
...
-Filterung der Daten zur Beseitigung von Rauschen und Bewegungsartefakten -> Bandpass Filter

-hier wird nur Hoch Pass Filter angewendet -> Bewegungsartefakte

-standardisierung der Zeitdaten und FFT Daten
"""
...
"""speicherung der Daten nach dem letzten Preprocessing Schritt um effektiver Training ab hier fortzusetzen """
...
"""Optimierung des Models für Zeitserien in Bezug auf Anzahl Schichten, Anzahl Filter, Regularisierung in CNN Schichten, Dense Layer Anzahl Neuronen, Dropout, Regularisierung in Dense Schicht"""
...
"""Optimierung der Architektur für Model mit Zetiserie und FFT"""
...
# Optimierung FFT+ZeitserienModel
...
"""# Training von individuellen Modellen
...
Idee um bessere Features zu bekommen welche zum training eines weiteren Models verwendet werden können, fand keine Anwendung in diesem Modell aus zeitlichen Gründen
"""
...
Training von einzelnen Netzwerken
"""

model = make_model_FFT()
# Load the model from the saved checkpoint to continue from previous training spot
...
checkpoint = ModelCheckpoint(filepath='/content/drive/My Drive/best_model_fft0.h5', 
                             ...
                             save_best_only=True, 
                             verbose=1)
#Training von Model mit beiden Datensätzen aufeinmal
#fft+Time signal 
# history = model.fit(
...
"""Training von Random Forrest Neuronalen Netzwerken für Stack Modell
hier werden zufällig Daten aus dem Datensatz gezogen mit welchem ein Neuronales Netzwerk trainiert wird
"""

#diese Funktion hilft dabei die Rechenintensiven Berechnung von vielen Neuronalen Netzen zu beschleunigen indem es abbricht sobald ein bekannter threshold erreicht wurde
...
n_models = 15 # Anzahl der Modelle die trainiert werden sollen
stop_value = 0.72 # threshold nachdem training gestoppt wird
...
get predictions for each model and combine them to new Training and Validation Data
"""
